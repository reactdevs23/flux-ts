...
// Define the type for the Slide component props
...
const Slide: React.FC<SlideProps> = ({ name, img, feedback, country }) => {
  return (
    <div className="flex items-center h-full">
      <div className="flex gap-4 lg:gap-6  bg-white p-6 md:p-8 rounded-[19px]">
        <h2 className="opacity-60 	 font-unbounded text-gray text-[50px] md:text-[70px] lg:text-[90px] xl:text-[110px] leading-none -mt-4 lg:-mt-2 inline-block font-medium leading-none">
          “
        </h2>
